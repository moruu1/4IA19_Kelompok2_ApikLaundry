...
async function saveAdd() {
  ...
  if (result.success) {
    ...
    toast.value = {
      show: true,
      message: result.error || 'Gagal menambahkan data',
      type: 'error'
    }
  }
    ...
    <div v-if="showAddModal" class="modal-overlay" @click="closeAddModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="form-group">
          <label>Tanggal</label>
          <input v-model="addForm.tanggal" type="date" class="form-input" />
        </div>
        ...
        <div class="form-group">
          ...
          <textarea v-model="addForm.keterangan" class="form-input" rows="3" placeholder="Contoh: Pembelian Detergen, Gaji Karyawan, dll"></textarea>
        </div>

        <div class="form-group">
          <label>Jumlah (Rp)</label>
          <input v-model.number="addForm.jumlah" type="number" class="form-input" placeholder="0" />
        </div>
